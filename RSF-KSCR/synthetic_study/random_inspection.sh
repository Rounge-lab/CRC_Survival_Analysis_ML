...
file_1="run_${run}_df_strong_coef_full_t0.csv"
...
do
    ...
    # and save the chosen variables as a csv file in data_sets/covars subfolder and eval files in results perliminary subfolder 
    ...
    python random_inspection.py $f ${name}${rsf_chosen} ${name}${test_id} 1 0
