...
title_str <- "Time varying AUC with 95% confidence bands by data group\n and covariate subset using all available data"
...
tp_str <- "tp_df_all.csv"
fp_str <- "fp_df_all.csv"
ppv_str <- "ppv_df_all.csv"
npv_str <- "npv_df_all.csv"
